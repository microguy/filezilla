...
; MicroGuy Edition: Removed bundled software/adware offers
...
!endif
  ...
  ${If} $PERFORM_UPDATE == 0
    ...
    ; MicroGuy Edition: Always mark as clean install without bundled software
...
!if "an ar az bg_BG ca ca_ES@valencia co cs_CZ cy da de el en es et eu fa_IR fi_FI fr ga gl_ES he_IL hr hu_HU hy id_ID is it ja_JP ka kab km_KH ko_KR ku ky lo_LA lt_LT lv_LV mk_MK nb_NO ne nl nn_NO oc pl_PL pt_BR pt_PT ro_RO ru sk_SK sl_SI sr sv ta th_TH tr uk_UA vi_VN zh_CN zh_TW" != ""
